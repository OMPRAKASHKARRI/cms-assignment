// Central error type. Every deliberately-thrown error in the app should be
// an ApiError so the error middleware can format a consistent response
// without guessing status codes from generic Error instances.
